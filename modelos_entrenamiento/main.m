...
[w_BGD, valor_costo_BGD] = batch_gradient_descent(w, x, t, alpha, epocas);
[w_SGD, valor_costo_SGD] = stochastic_gradient_descent(w, x, t, alpha, epocas);
[w_MBGD, valor_costo_MBGD] = minibatch_gradient_descent(w, x, t, alpha, epocas, 200);
...
mesh(w1, w2, P_BGD)
hold on
scatter3(x(2,:), x(3,:),t+3, 25, t+2, 'filled');
