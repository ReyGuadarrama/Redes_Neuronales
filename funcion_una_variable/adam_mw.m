function [x, m, v, m_hat, v_hat, gradient_history] = adam_mw(x, df, m, v, t, lr, beta1, beta2, window_size, gradient_history)
    ...
    m = beta1 * m + (1 - beta1) * mean(gradient_history);
    v = beta2 * v + (1 - beta2) * mean(gradient_history.^2);
